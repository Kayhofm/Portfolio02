...
description: "Led multimodal input strategy and created frameworks adopted across AR research."
...
<ImageGallery>
  ...
  <MDXImage
    src="/images/MetaUseCasesBrainstorm.webp"
...
<ImageGallery>
  ...
  <MDXVideo
    src="https://res.cloudinary.com/dcrb9u53g/video/upload/v1754691910/Meta9_UX_Prototyping_Supercut_2_mzwiia.mp4"
    autoplay={true}
    loop={true}
    muted={true}
  />
