...
description: "Founded design org and voice model; launch beat forecast 10×, with industry-leading ratings"
...
<ImageGallery>
  ...
  <MDXImage
    src="/images/AlexaStillPhoto15b_Doppler_0342_jw_v1.webp"
...
<ImageGallery>
  ...
  <div>
    <div className="flex justify-center items-center gap-18 mb-8 mt-18">
      <div className="flex flex-col items-center">
        <ClickableSpeakerIcon 
          audioSrc="/audio/AlexaSalli_tts_03.wav" 
          label="before" 
        />
      ...
      <div className="flex flex-col items-center">
        <ClickableSpeakerIcon 
          audioSrc="/audio/AlexaNewVoice.mp3" 
          label="after" 
        />
...
<ImageGallery>
  ...
  <MDXImage
    src="/images/AlexaStillPhoto10_0343_jw_v1.webp"
